...
import com.example.project.databinding.FragmentTimetable3Binding

class TimetableFragment3: Fragment() {
    @SuppressLint("SetTextI18n")
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val binding = FragmentTimetable3Binding.inflate(inflater)
        val weekday = "Среда"
    ...
    companion object {
        @JvmStatic
        fun newInstance() = TimetableFragment3()
    }
}