...
import com.example.project.databinding.FragmentTimetable1Binding

class TimetableFragment1: Fragment() {
    @SuppressLint("SetTextI18n")
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val binding = FragmentTimetable1Binding.inflate(inflater)
    ...
    companion object {
        @JvmStatic
        fun newInstance() = TimetableFragment1()
    }
}