...
import com.example.project.databinding.FragmentTimetable2Binding
...
class TimetableFragment2: Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentTimetable2Binding.inflate(inflater)
        val weekday = "Вторник"
    ...
    companion object {
        @JvmStatic
        fun newInstance() = TimetableFragment2()
    }
}