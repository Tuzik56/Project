...
import com.example.project.databinding.FragmentTimetable6Binding

class TimetableFragment6: Fragment() {
    @SuppressLint("SetTextI18n")
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val binding = FragmentTimetable6Binding.inflate(inflater)
        val weekday = "Суббота"
    ...
    companion object {
        @JvmStatic
        fun newInstance() = TimetableFragment6()
    }
}