...
import com.example.project.databinding.FragmentTimetable5Binding

class TimetableFragment5: Fragment() {
    @SuppressLint("SetTextI18n")
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val binding = FragmentTimetable5Binding.inflate(inflater)
        val weekday = "Пятница"
    ...
    companion object {
        @JvmStatic
        fun newInstance() = TimetableFragment5()
    }
}